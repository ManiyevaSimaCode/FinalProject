...
namespace SimRaMVC.Areas.Manage.Controllers
{
    ...
    public class SubCategoryController : Controller
    {
        ...
        {
            subCategoryUpdateDto.subCategoryPostDto.Category = await _categoryService.GetByIdAsync(subCategoryUpdateDto.subCategoryPostDto.CategoryId);
            //for (int i = 0; i < subCategoryUpdateDto.subCategoryPostDto.ParameterIds.Count; i++)
            //{
            //    subCategoryUpdateDto.subCategoryPostDto.SubCategoryParameters = 
            //}
