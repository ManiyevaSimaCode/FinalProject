namespace DAL.Utilities.Configurations
{
    public class CompanyConfiguration : IEntityTypeConfiguration<Company>
    {
        public void Configure(EntityTypeBuilder<Company> builder)
        {
            ...
            builder.Property(c => c.FacebookUrl).HasMaxLength(255);
            builder.Property(c => c.LinkedinUrl).HasMaxLength(255);
            builder.Property(c => c.TwitterUrl).HasMaxLength(255);
            builder.Property(c => c.InstagramUrl).HasMaxLength(255);
